...
HX_DEFINE_STACK_FRAME(_hx_pos_902ca00cf00ab6ae_9_new,"haxe.MainEvent","new",0x1c640c2b,"haxe.MainEvent.new","/usr/local/lib/haxe-4.3.7-std/haxe/MainLoop.hx",9,0xa6ff9e3e)
namespace haxe{

void MainEvent_obj::__construct( ::Dynamic f,int p){
            	HX_STACKFRAME(&_hx_pos_902ca00cf00ab6ae_9_new)
