...
HX_DEFINE_STACK_FRAME(_hx_pos_a043dd0fa9dcaed3_23_new,"haxe.ValueException","new",0xb19045f8,"haxe.ValueException.new","/usr/local/lib/haxe-4.3.7-std/haxe/ValueException.hx",23,0xdb54a53d)
namespace haxe{

void ValueException_obj::__construct( ::Dynamic value, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_a043dd0fa9dcaed3_23_new)
