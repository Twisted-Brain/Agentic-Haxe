...
HX_LOCAL_STACK_FRAME(_hx_pos_1e2dcce82aff00c3_12_saveStack,"haxe.NativeStackTrace","saveStack",0x471b27d9,"haxe.NativeStackTrace.saveStack","/usr/local/lib/haxe-4.3.7-std/cpp/_std/haxe/NativeStackTrace.hx",12,0x8bbc129a)
namespace haxe{
...
void NativeStackTrace_obj::saveStack( ::Dynamic exception){
            	HX_STACKFRAME(&_hx_pos_1e2dcce82aff00c3_12_saveStack)
            	}
