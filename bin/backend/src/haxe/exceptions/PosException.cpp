...
HX_DEFINE_STACK_FRAME(_hx_pos_22ae450b5ed8a2e8_12_new,"haxe.exceptions.PosException","new",0x9ed038cf,"haxe.exceptions.PosException.new","/usr/local/lib/haxe-4.3.7-std/haxe/exceptions/PosException.hx",12,0xaef0f93b)
HX_LOCAL_STACK_FRAME(_hx_pos_22ae450b5ed8a2e8_25_toString,"haxe.exceptions.PosException","toString",0x179675dd,"haxe.exceptions.PosException.toString","/usr/local/lib/haxe-4.3.7-std/haxe/exceptions/PosException.hx",25,0xaef0f93b)
namespace haxe{
namespace exceptions{

void PosException_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic pos){
            	HX_STACKFRAME(&_hx_pos_22ae450b5ed8a2e8_12_new)
...
::String PosException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_22ae450b5ed8a2e8_25_toString)
