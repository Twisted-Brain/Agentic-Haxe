...
HX_DEFINE_STACK_FRAME(_hx_pos_95982dbe0589a4b0_8_new,"haxe.exceptions.NotImplementedException","new",0xcfd1d5d0,"haxe.exceptions.NotImplementedException.new","/usr/local/lib/haxe-4.3.7-std/haxe/exceptions/NotImplementedException.hx",8,0x24ec7626)
namespace haxe{
...
void NotImplementedException_obj::__construct(::String __o_message, ::haxe::Exception previous, ::Dynamic pos){
            	...
            	HX_STACKFRAME(&_hx_pos_95982dbe0589a4b0_8_new)
