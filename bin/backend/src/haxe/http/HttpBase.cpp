...
HX_LOCAL_STACK_FRAME(_hx_pos_f15d12b52422efd5_214___default_onError,"haxe.http.HttpBase","__default_onError",0x84bb4354,"haxe.http.HttpBase.__default_onError","/usr/local/lib/haxe-4.3.7-std/haxe/http/HttpBase.hx",214,0x96b80061)
HX_LOCAL_STACK_FRAME(_hx_pos_f15d12b52422efd5_223___default_onStatus,"haxe.http.HttpBase","__default_onStatus",0x53b30a26,"haxe.http.HttpBase.__default_onStatus","/usr/local/lib/haxe-4.3.7-std/haxe/http/HttpBase.hx",223,0x96b80061)
HX_LOCAL_STACK_FRAME(_hx_pos_f15d12b52422efd5_229_hasOnData,"haxe.http.HttpBase","hasOnData",0xc242adec,"haxe.http.HttpBase.hasOnData","/usr/local/lib/haxe-4.3.7-std/haxe/http/HttpBase.hx",229,0x96b80061)
HX_LOCAL_STACK_FRAME(_hx_pos_f15d12b52422efd5_232_success,"haxe.http.HttpBase","success",0xfe1e7d8c,"haxe.http.HttpBase.success","/usr/local/lib/haxe-4.3.7-std/haxe/http/HttpBase.hx",232,0x96b80061)
HX_LOCAL_STACK_FRAME(_hx_pos_f15d12b52422efd5_241_get_responseData,"haxe.http.HttpBase","get_responseData",0x92ecd8eb,"haxe.http.HttpBase.get_responseData","/usr/local/lib/haxe-4.3.7-std/haxe/http/HttpBase.hx",241,0x96b80061)
namespace haxe{
namespace http{

void HttpBase_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_f15d12b52422efd5_71_new)
...
void _hx_run(::String data){
            	HX_STACKFRAME(&_hx_pos_f15d12b52422efd5_196___default_onData)
            	}
...
void _hx_run( ::haxe::io::Bytes data){
            	HX_STACKFRAME(&_hx_pos_f15d12b52422efd5_205___default_onBytes)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC
...
void _hx_run(::String msg){
            	HX_STACKFRAME(&_hx_pos_f15d12b52422efd5_214___default_onError)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC
...
void _hx_run(int status){
            	HX_STACKFRAME(&_hx_pos_f15d12b52422efd5_223___default_onStatus)
            	}
HX_END_LOCAL_FUNC1((void))
HX_END_DEFAULT_FUNC

bool HttpBase_obj::hasOnData(){
            	HX_STACKFRAME(&_hx_pos_f15d12b52422efd5_229_hasOnData)
...
void HttpBase_obj::success( ::haxe::io::Bytes data){
            	HX_STACKFRAME(&_hx_pos_f15d12b52422efd5_232_success)
...
::String HttpBase_obj::get_responseData(){
            	HX_STACKFRAME(&_hx_pos_f15d12b52422efd5_241_get_responseData)
