...
HX_LOCAL_STACK_FRAME(_hx_pos_58a50231e45af7a4_126_run,"haxe.EntryPoint","run",0xf0324cc3,"haxe.EntryPoint.run","/usr/local/lib/haxe-4.3.7-std/haxe/EntryPoint.hx",126,0x0c6f4add)
namespace haxe{
...
void EntryPoint_obj::run(){
            	HX_STACKFRAME(&_hx_pos_58a50231e45af7a4_126_run)
            	}
