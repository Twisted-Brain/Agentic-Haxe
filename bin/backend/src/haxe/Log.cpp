...
HX_LOCAL_STACK_FRAME(_hx_pos_12e00552a150fd8d_30___default_trace,"haxe.Log","__default_trace",0xe2f5e5d5,"haxe.Log.__default_trace","/usr/local/lib/haxe-4.3.7-std/cpp/_std/haxe/Log.hx",30,0xa36550ca)
namespace haxe{
...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_12e00552a150fd8d_30___default_trace)
