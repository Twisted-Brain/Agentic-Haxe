...
HX_DEFINE_STACK_FRAME(_hx_pos_5d9989d22ac4068b_39_new,"haxe.Exception","new",0xa32fba59,"haxe.Exception.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/haxe/Exception.hx",39,0x9f8431df)
HX_LOCAL_STACK_FRAME(_hx_pos_5d9989d22ac4068b_56_toString,"haxe.Exception","toString",0x11a32013,"haxe.Exception.toString","/usr/local/lib/haxe-4.3.7-std/cpp/_std/haxe/Exception.hx",56,0x9f8431df)
HX_LOCAL_STACK_FRAME(_hx_pos_5d9989d22ac4068b_76_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","/usr/local/lib/haxe-4.3.7-std/cpp/_std/haxe/Exception.hx",76,0x9f8431df)
namespace haxe{

void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_5d9989d22ac4068b_39_new)
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_5d9989d22ac4068b_56_toString)
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_5d9989d22ac4068b_76_get_message)
