...
HX_DEFINE_STACK_FRAME(_hx_pos_dae4aa6e16cdbbe4_52_new,"haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","/usr/local/lib/haxe-4.3.7-std/haxe/io/BytesBuffer.hx",52,0x37469db9)
HX_LOCAL_STACK_FRAME(_hx_pos_dae4aa6e16cdbbe4_202_getBytes,"haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","/usr/local/lib/haxe-4.3.7-std/haxe/io/BytesBuffer.hx",202,0x37469db9)
namespace haxe{
namespace io{

void BytesBuffer_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_dae4aa6e16cdbbe4_52_new)
...
bool BytesBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes BytesBuffer_obj::getBytes(){
            	HX_GC_STACKFRAME(&_hx_pos_dae4aa6e16cdbbe4_202_getBytes)
