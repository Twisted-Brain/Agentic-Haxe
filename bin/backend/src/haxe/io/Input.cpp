...
HX_LOCAL_STACK_FRAME(_hx_pos_295a7efd8d13edd3_51_readByte,"haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","/usr/local/lib/haxe-4.3.7-std/haxe/io/Input.hx",51,0x97ab165a)
HX_LOCAL_STACK_FRAME(_hx_pos_295a7efd8d13edd3_64_readBytes,"haxe.io.Input","readBytes",0xdda6a671,"haxe.io.Input.readBytes","/usr/local/lib/haxe-4.3.7-std/haxe/io/Input.hx",64,0x97ab165a)
HX_LOCAL_STACK_FRAME(_hx_pos_295a7efd8d13edd3_92_close,"haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","/usr/local/lib/haxe-4.3.7-std/haxe/io/Input.hx",92,0x97ab165a)
namespace haxe{
namespace io{
...
int Input_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_295a7efd8d13edd3_51_readByte)
...
int Input_obj::readBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_295a7efd8d13edd3_64_readBytes)
HXLINE(  65)		int k = len;
...
void Input_obj::close(){
            	HX_STACKFRAME(&_hx_pos_295a7efd8d13edd3_92_close)
            	}
