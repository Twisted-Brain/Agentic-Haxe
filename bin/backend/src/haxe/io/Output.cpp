...
HX_LOCAL_STACK_FRAME(_hx_pos_8257f2de7e61e51d_47_writeByte,"haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","/usr/local/lib/haxe-4.3.7-std/haxe/io/Output.hx",47,0x081e8e37)
HX_LOCAL_STACK_FRAME(_hx_pos_8257f2de7e61e51d_57_writeBytes,"haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","/usr/local/lib/haxe-4.3.7-std/haxe/io/Output.hx",57,0x081e8e37)
HX_LOCAL_STACK_FRAME(_hx_pos_8257f2de7e61e51d_92_close,"haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","/usr/local/lib/haxe-4.3.7-std/haxe/io/Output.hx",92,0x081e8e37)
HX_LOCAL_STACK_FRAME(_hx_pos_8257f2de7e61e51d_121_writeFullBytes,"haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","/usr/local/lib/haxe-4.3.7-std/haxe/io/Output.hx",121,0x081e8e37)
HX_LOCAL_STACK_FRAME(_hx_pos_8257f2de7e61e51d_246_prepare,"haxe.io.Output","prepare",0xcd01ec7a,"haxe.io.Output.prepare","/usr/local/lib/haxe-4.3.7-std/haxe/io/Output.hx",246,0x081e8e37)
HX_LOCAL_STACK_FRAME(_hx_pos_8257f2de7e61e51d_278_writeString,"haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","/usr/local/lib/haxe-4.3.7-std/haxe/io/Output.hx",278,0x081e8e37)
namespace haxe{
namespace io{
...
void Output_obj::writeByte(int c){
            	HX_GC_STACKFRAME(&_hx_pos_8257f2de7e61e51d_47_writeByte)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_8257f2de7e61e51d_57_writeBytes)
...
void Output_obj::close(){
            	HX_STACKFRAME(&_hx_pos_8257f2de7e61e51d_92_close)
            	}
...
void Output_obj::writeFullBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_8257f2de7e61e51d_121_writeFullBytes)
...
void Output_obj::prepare(int nbytes){
            	HX_STACKFRAME(&_hx_pos_8257f2de7e61e51d_246_prepare)
            	}
...
void Output_obj::writeString(::String s, ::haxe::io::Encoding encoding){
            	HX_STACKFRAME(&_hx_pos_8257f2de7e61e51d_278_writeString)
