...
HX_LOCAL_STACK_FRAME(_hx_pos_5c762acc5c9ddefc_125_exists,"Lambda","exists",0x65091043,"Lambda.exists","/usr/local/lib/haxe-4.3.7-std/Lambda.hx",125,0xa0c797d1)
...
bool Lambda_obj::exists( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_5c762acc5c9ddefc_125_exists)
HXLINE( 126)		{
