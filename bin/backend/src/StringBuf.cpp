...
HX_DEFINE_STACK_FRAME(_hx_pos_363d5fc936136c1a_35_new,"StringBuf","new",0xaaa8f4b4,"StringBuf.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/StringBuf.hx",35,0xf7a88d75)
HX_LOCAL_STACK_FRAME(_hx_pos_363d5fc936136c1a_37_charBufAsString,"StringBuf","charBufAsString",0x54d38cd4,"StringBuf.charBufAsString","/usr/local/lib/haxe-4.3.7-std/cpp/_std/StringBuf.hx",37,0xf7a88d75)
HX_LOCAL_STACK_FRAME(_hx_pos_363d5fc936136c1a_43_flush,"StringBuf","flush",0xc7c14418,"StringBuf.flush","/usr/local/lib/haxe-4.3.7-std/cpp/_std/StringBuf.hx",43,0xf7a88d75)
HX_LOCAL_STACK_FRAME(_hx_pos_363d5fc936136c1a_51_get_length,"StringBuf","get_length",0xe673d2db,"StringBuf.get_length","/usr/local/lib/haxe-4.3.7-std/cpp/_std/StringBuf.hx",51,0xf7a88d75)
HX_LOCAL_STACK_FRAME(_hx_pos_363d5fc936136c1a_92_toString,"StringBuf","toString",0x68f17bd8,"StringBuf.toString","/usr/local/lib/haxe-4.3.7-std/cpp/_std/StringBuf.hx",92,0xf7a88d75)

void StringBuf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_363d5fc936136c1a_35_new)
            	}
...
::String StringBuf_obj::charBufAsString(){
            	HX_STACKFRAME(&_hx_pos_363d5fc936136c1a_37_charBufAsString)
...
void StringBuf_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_363d5fc936136c1a_43_flush)
...
int StringBuf_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_363d5fc936136c1a_51_get_length)
HXLINE(  52)		int len = 0;
...
::String StringBuf_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_363d5fc936136c1a_92_toString)
