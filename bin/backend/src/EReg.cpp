...
HX_DEFINE_STACK_FRAME(_hx_pos_6ae4cb673140f89e_28_new,"EReg","new",0x8b859e81,"EReg.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/EReg.hx",28,0xb6b1e676)
HX_LOCAL_STACK_FRAME(_hx_pos_6ae4cb673140f89e_36_match,"EReg","match",0x18fda1a6,"EReg.match","/usr/local/lib/haxe-4.3.7-std/cpp/_std/EReg.hx",36,0xb6b1e676)
HX_LOCAL_STACK_FRAME(_hx_pos_6ae4cb673140f89e_45_matched,"EReg","matched",0x8ce62f85,"EReg.matched","/usr/local/lib/haxe-4.3.7-std/cpp/_std/EReg.hx",45,0xb6b1e676)
HX_LOCAL_STACK_FRAME(_hx_pos_6ae4cb673140f89e_62_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","/usr/local/lib/haxe-4.3.7-std/cpp/_std/EReg.hx",62,0xb6b1e676)

void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_6ae4cb673140f89e_28_new)
...
bool EReg_obj::match(::String s){
            	HX_STACKFRAME(&_hx_pos_6ae4cb673140f89e_36_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_6ae4cb673140f89e_45_matched)
...
HX_DEFINE_DYNAMIC_FUNC1(EReg_obj,matched,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_6ae4cb673140f89e_62_matchedPos)
