...
HX_LOCAL_STACK_FRAME(_hx_pos_fd4d59c1d233870c_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/FileSystem.hx",31,0x93e01658)
HX_LOCAL_STACK_FRAME(_hx_pos_fd4d59c1d233870c_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/FileSystem.hx",75,0x93e01658)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_fd4d59c1d233870c_31_exists)
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_fd4d59c1d233870c_75_isDirectory)
