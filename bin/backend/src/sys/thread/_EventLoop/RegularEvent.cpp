...
HX_DEFINE_STACK_FRAME(_hx_pos_e3e606d100ae8256_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","/usr/local/lib/haxe-4.3.7-std/sys/thread/EventLoop.hx",278,0xc3a2bdbd)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_e3e606d100ae8256_278_new)
