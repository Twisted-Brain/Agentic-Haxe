...
HX_DEFINE_STACK_FRAME(_hx_pos_259f023028829526_30_new,"sys.thread.Lock","new",0x586e3f40,"sys.thread.Lock.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/thread/Lock.hx",30,0xfb4e5b09)
HX_LOCAL_STACK_FRAME(_hx_pos_259f023028829526_34_wait,"sys.thread.Lock","wait",0x0df8ef95,"sys.thread.Lock.wait","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/thread/Lock.hx",34,0xfb4e5b09)
namespace sys{
namespace thread{

void Lock_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_259f023028829526_30_new)
...
bool Lock_obj::wait( ::Dynamic __o_timeout){
            	...
            	HX_STACKFRAME(&_hx_pos_259f023028829526_34_wait)
