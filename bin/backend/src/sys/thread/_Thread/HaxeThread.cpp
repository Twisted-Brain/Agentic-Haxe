...
HX_DEFINE_STACK_FRAME(_hx_pos_869bb3b0127341d0_171_new,"sys.thread._Thread.HaxeThread","new",0x28e1daea,"sys.thread._Thread.HaxeThread.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/thread/Thread.hx",171,0x9b3cd30a)
HX_LOCAL_STACK_FRAME(_hx_pos_a7593bbea16335d1_79___init__,"::sys::thread::_Thread::HaxeThread_obj","__init__",0x85b0f2c4,"::sys::thread::_Thread::HaxeThread_obj.__init__","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/thread/Thread.hx",79,0x9b3cd30a)
HX_LOCAL_STACK_FRAME(_hx_pos_869bb3b0127341d0_91_current,"sys.thread._Thread.HaxeThread","current",0xca8ab3c3,"sys.thread._Thread.HaxeThread.current","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/thread/Thread.hx",91,0x9b3cd30a)
namespace sys{
namespace thread{
namespace _Thread{

void HaxeThread_obj::__construct( ::Dynamic h){
            	HX_STACKFRAME(&_hx_pos_869bb3b0127341d0_171_new)
...
void HaxeThread_obj::__init__(){
            	HX_GC_STACKFRAME(&_hx_pos_a7593bbea16335d1_79___init__)
...
::Array< ::Dynamic> HaxeThread_obj::threads;
 ...
 ::sys::thread::_Thread::HaxeThread HaxeThread_obj::current(){
            	HX_GC_STACKFRAME(&_hx_pos_869bb3b0127341d0_91_current)
