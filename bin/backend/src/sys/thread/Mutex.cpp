...
HX_DEFINE_STACK_FRAME(_hx_pos_68d81bccdeb8daef_30_new,"sys.thread.Mutex","new",0x0051f1ae,"sys.thread.Mutex.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/thread/Mutex.hx",30,0xa45be889)
HX_LOCAL_STACK_FRAME(_hx_pos_68d81bccdeb8daef_34_acquire,"sys.thread.Mutex","acquire",0xae482c24,"sys.thread.Mutex.acquire","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/thread/Mutex.hx",34,0xa45be889)
HX_LOCAL_STACK_FRAME(_hx_pos_68d81bccdeb8daef_42_release,"sys.thread.Mutex","release",0x52516615,"sys.thread.Mutex.release","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/thread/Mutex.hx",42,0xa45be889)
namespace sys{
namespace thread{

void Mutex_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_68d81bccdeb8daef_30_new)
...
void Mutex_obj::acquire(){
            	HX_STACKFRAME(&_hx_pos_68d81bccdeb8daef_34_acquire)
...
void Mutex_obj::release(){
            	HX_STACKFRAME(&_hx_pos_68d81bccdeb8daef_42_release)
