...
HX_DEFINE_STACK_FRAME(_hx_pos_87c784747e64401a_115_new,"sys.net.Socket","new",0x202a8cf7,"sys.net.Socket.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Socket.hx",115,0x804e6abe)
HX_LOCAL_STACK_FRAME(_hx_pos_87c784747e64401a_133_init,"sys.net.Socket","init",0x01c98299,"sys.net.Socket.init","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Socket.hx",133,0x804e6abe)
HX_LOCAL_STACK_FRAME(_hx_pos_87c784747e64401a_145_close,"sys.net.Socket","close",0x18d3680f,"sys.net.Socket.close","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Socket.hx",145,0x804e6abe)
HX_LOCAL_STACK_FRAME(_hx_pos_87c784747e64401a_170_connect,"sys.net.Socket","connect",0x1ee69001,"sys.net.Socket.connect","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Socket.hx",170,0x804e6abe)
HX_LOCAL_STACK_FRAME(_hx_pos_87c784747e64401a_199_shutdown,"sys.net.Socket","shutdown",0x9b2f3c9f,"sys.net.Socket.shutdown","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Socket.hx",199,0x804e6abe)
HX_LOCAL_STACK_FRAME(_hx_pos_87c784747e64401a_245_setTimeout,"sys.net.Socket","setTimeout",0x1b505368,"sys.net.Socket.setTimeout","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Socket.hx",245,0x804e6abe)
HX_LOCAL_STACK_FRAME(_hx_pos_87c784747e64401a_254_setBlocking,"sys.net.Socket","setBlocking",0xe5689b0e,"sys.net.Socket.setBlocking","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Socket.hx",254,0x804e6abe)
HX_LOCAL_STACK_FRAME(_hx_pos_87c784747e64401a_259_setFastSend,"sys.net.Socket","setFastSend",0x54236f5d,"sys.net.Socket.setFastSend","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Socket.hx",259,0x804e6abe)
namespace sys{
namespace net{

void Socket_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_87c784747e64401a_115_new)
...
void Socket_obj::init(){
            	HX_GC_STACKFRAME(&_hx_pos_87c784747e64401a_133_init)
...
void Socket_obj::close(){
            	HX_STACKFRAME(&_hx_pos_87c784747e64401a_145_close)
...
void Socket_obj::connect( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_87c784747e64401a_170_connect)
HXDLIN( 170)		try {
...
void Socket_obj::shutdown(bool read,bool write){
            	HX_STACKFRAME(&_hx_pos_87c784747e64401a_199_shutdown)
...
void Socket_obj::setTimeout(Float timeout){
            	HX_STACKFRAME(&_hx_pos_87c784747e64401a_245_setTimeout)
...
void Socket_obj::setBlocking(bool b){
            	HX_STACKFRAME(&_hx_pos_87c784747e64401a_254_setBlocking)
...
void Socket_obj::setFastSend(bool b){
            	HX_STACKFRAME(&_hx_pos_87c784747e64401a_259_setFastSend)
