...
HX_DEFINE_STACK_FRAME(_hx_pos_5b01b3f21c263367_35_new,"sys.net.Host","new",0x056496ac,"sys.net.Host.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Host.hx",35,0x0e577b69)
HX_LOCAL_STACK_FRAME(_hx_pos_1ae9bc9c8d6a5e30_57___init__,"::sys::net::Host_obj","__init__",0x01315e0e,"::sys::net::Host_obj.__init__","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Host.hx",57,0x0e577b69)
HX_LOCAL_STACK_FRAME(_hx_pos_5b01b3f21c263367_45_toString,"sys.net.Host","toString",0xe5efb6e0,"sys.net.Host.toString","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/net/Host.hx",45,0x0e577b69)
namespace sys{
namespace net{

void Host_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_5b01b3f21c263367_35_new)
...
void Host_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_1ae9bc9c8d6a5e30_57___init__)
HXDLIN(  57)		_hx_std_socket_init();
            	}


::String Host_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_5b01b3f21c263367_45_toString)
