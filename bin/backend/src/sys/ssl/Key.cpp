...
HX_DEFINE_STACK_FRAME(_hx_pos_2960ff0116d71e9f_34_new,"sys.ssl.Key","new",0xfc27226e,"sys.ssl.Key.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Key.hx",34,0xf160173d)
HX_LOCAL_STACK_FRAME(_hx_pos_a716ea78cdc33b62_55___init__,"::sys::ssl::Key_obj","__init__",0x25088cc6,"::sys::ssl::Key_obj.__init__","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Key.hx",55,0xf160173d)
namespace sys{
namespace ssl{

void Key_obj::__construct( ::Dynamic k){
            	HX_STACKFRAME(&_hx_pos_2960ff0116d71e9f_34_new)
...
void Key_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_a716ea78cdc33b62_55___init__)
