...
HX_DEFINE_STACK_FRAME(_hx_pos_b99d7540dead8cf2_119_new,"sys.ssl.Socket","new",0xb0189de8,"sys.ssl.Socket.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",119,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_4d27f43ef40f5a5e_295___init__,"::sys::ssl::Socket_obj","__init__",0xb5703314,"::sys::ssl::Socket_obj.__init__","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",295,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_b99d7540dead8cf2_138_init,"sys.ssl.Socket","init",0x622a4488,"sys.ssl.Socket.init","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",138,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_b99d7540dead8cf2_152_connect,"sys.ssl.Socket","connect",0x6aae6d72,"sys.ssl.Socket.connect","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",152,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_b99d7540dead8cf2_174_handshake,"sys.ssl.Socket","handshake",0x5679847f,"sys.ssl.Socket.handshake","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",174,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_b99d7540dead8cf2_213_close,"sys.ssl.Socket","close",0x0d1c5740,"sys.ssl.Socket.close","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",213,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_b99d7540dead8cf2_260_buildSSLConfig,"sys.ssl.Socket","buildSSLConfig",0xf55ff618,"sys.ssl.Socket.buildSSLConfig","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",260,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_b99d7540dead8cf2_267_buildSSLConfig,"sys.ssl.Socket","buildSSLConfig",0xf55ff618,"sys.ssl.Socket.buildSSLConfig","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",267,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_b99d7540dead8cf2_120_boot,"sys.ssl.Socket","boot",0x5d8a8daa,"sys.ssl.Socket.boot","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",120,0x6e9582ed)
namespace sys{
namespace ssl{

void Socket_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b99d7540dead8cf2_119_new)
...
void Socket_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_4d27f43ef40f5a5e_295___init__)
HXDLIN( 295)		_hx_ssl_init();
            	}


void Socket_obj::init(){
            	HX_GC_STACKFRAME(&_hx_pos_b99d7540dead8cf2_138_init)
...
void Socket_obj::connect( ::sys::net::Host host,int port){
            	HX_STACKFRAME(&_hx_pos_b99d7540dead8cf2_152_connect)
HXDLIN( 152)		try {
...
void Socket_obj::handshake(){
            	HX_STACKFRAME(&_hx_pos_b99d7540dead8cf2_174_handshake)
...
void Socket_obj::close(){
            	HX_STACKFRAME(&_hx_pos_b99d7540dead8cf2_213_close)
...
HXLINE( 225)		output->close();
 ...
 ::Dynamic Socket_obj::buildSSLConfig(bool server){
            	HX_STACKFRAME(&_hx_pos_b99d7540dead8cf2_260_buildSSLConfig)
...
HXLINE( 266)		if (::hx::IsNotNull( this->altSNIContexts )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::sys::ssl::Socket,_gthis) HXARGC(1)
            			 ::Dynamic _hx_run( ::Dynamic servername){
            				HX_STACKFRAME(&_hx_pos_b99d7540dead8cf2_267_buildSSLConfig)
...
{
{
            	HX_STACKFRAME(&_hx_pos_b99d7540dead8cf2_120_boot)
