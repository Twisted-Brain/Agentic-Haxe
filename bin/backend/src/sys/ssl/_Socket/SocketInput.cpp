...
HX_DEFINE_STACK_FRAME(_hx_pos_7c85d15880290f89_36_new,"sys.ssl._Socket.SocketInput","new",0x0d9c972a,"sys.ssl._Socket.SocketInput.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",36,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_7c85d15880290f89_40_readByte,"sys.ssl._Socket.SocketInput","readByte",0xa45b5674,"sys.ssl._Socket.SocketInput.readByte","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",40,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_7c85d15880290f89_53_readBytes,"sys.ssl._Socket.SocketInput","readBytes",0x2b904f7f,"sys.ssl._Socket.SocketInput.readBytes","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",53,0x6e9582ed)
HX_LOCAL_STACK_FRAME(_hx_pos_7c85d15880290f89_71_close,"sys.ssl._Socket.SocketInput","close",0xce82a502,"sys.ssl._Socket.SocketInput.close","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Socket.hx",71,0x6e9582ed)
namespace sys{
namespace ssl{
namespace _Socket{

void SocketInput_obj::__construct( ::sys::ssl::Socket s){
            	HX_STACKFRAME(&_hx_pos_7c85d15880290f89_36_new)
...
int SocketInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_7c85d15880290f89_40_readByte)
HXDLIN(  40)		try {
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_7c85d15880290f89_53_readBytes)
HXLINE(  54)		int r;
...
void SocketInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_7c85d15880290f89_71_close)
