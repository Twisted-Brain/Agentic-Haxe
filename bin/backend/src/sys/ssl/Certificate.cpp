...
HX_DEFINE_STACK_FRAME(_hx_pos_dc3ed8af8d11c7d3_33_new,"sys.ssl.Certificate","new",0x5388a2e6,"sys.ssl.Certificate.new","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Certificate.hx",33,0xec4dc0c5)
HX_LOCAL_STACK_FRAME(_hx_pos_2cc28041d09326d0_134___init__,"::sys::ssl::Certificate_obj","__init__",0x6779d94e,"::sys::ssl::Certificate_obj.__init__","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Certificate.hx",134,0xec4dc0c5)
HX_LOCAL_STACK_FRAME(_hx_pos_dc3ed8af8d11c7d3_39_loadFile,"sys.ssl.Certificate","loadFile",0xca3fe77c,"sys.ssl.Certificate.loadFile","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Certificate.hx",39,0xec4dc0c5)
HX_LOCAL_STACK_FRAME(_hx_pos_dc3ed8af8d11c7d3_43_loadPath,"sys.ssl.Certificate","loadPath",0xd0d5fea5,"sys.ssl.Certificate.loadPath","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Certificate.hx",43,0xec4dc0c5)
HX_LOCAL_STACK_FRAME(_hx_pos_dc3ed8af8d11c7d3_50_loadDefaults,"sys.ssl.Certificate","loadDefaults",0xcc9e6992,"sys.ssl.Certificate.loadDefaults","/usr/local/lib/haxe-4.3.7-std/cpp/_std/sys/ssl/Certificate.hx",50,0xec4dc0c5)
...
void Certificate_obj::__construct( ::Dynamic x, ::sys::ssl::Certificate h){
            	HX_STACKFRAME(&_hx_pos_dc3ed8af8d11c7d3_33_new)
...
void Certificate_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_2cc28041d09326d0_134___init__)
HXDLIN( 134)		_hx_ssl_init();
            	}


 ::sys::ssl::Certificate Certificate_obj::loadFile(::String file){
            	HX_GC_STACKFRAME(&_hx_pos_dc3ed8af8d11c7d3_39_loadFile)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,loadFile,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::loadPath(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_dc3ed8af8d11c7d3_43_loadPath)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Certificate_obj,loadPath,return )
 ...
 ::sys::ssl::Certificate Certificate_obj::loadDefaults(){
            	HX_GC_STACKFRAME(&_hx_pos_dc3ed8af8d11c7d3_50_loadDefaults)
