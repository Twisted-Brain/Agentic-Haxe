...
HX_LOCAL_STACK_FRAME(_hx_pos_8d4d9b7c9de3646b_30_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","/usr/local/lib/haxe-4.3.7-std/cpp/_std/Date.hx",30,0x2e271f97)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8d4d9b7c9de3646b_98_now,"Date","now",0x9aa26af6,"Date.now","/usr/local/lib/haxe-4.3.7-std/cpp/_std/Date.hx",98,0x2e271f97)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_8d4d9b7c9de3646b_30_getTime)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,toString,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_8d4d9b7c9de3646b_98_now)
